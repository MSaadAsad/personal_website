...
This is how the maneuvering of the three Dogra brothers in a collapsing Sikh Empire moved from the siege of Lahore toward the siege of Mangla, passing through Khari Khariyali -- today's [Mirpur](https://en.wikipedia.org/wiki/Mirpur,_Azad_Kashmir) tehsil, where I am from -- on what would become Gulab Singh's road to the throne of Jammu and Kashmir.
...
A Dogra-era [*thana*](https://en.wikipedia.org/wiki/Thana_(disambiguation)) also stood there, which might correspond to the fort we are looking for, but being so close to two rivers, the site has flooded repeatedly, as recently as 1992, making it hard to say if the original structure survived.
