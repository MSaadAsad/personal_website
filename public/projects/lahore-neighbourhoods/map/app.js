...
const base=L.tileLayer('https://{s}.basemaps.cartocdn.com/light_nolabels/{z}/{x}/{y}{r}.png',{maxZoom:20,subdomains:'abcd',attribution:'© OpenStreetMap contributors · © CARTO'}).addTo(map);
map.createPane('placeLabels');
map.getPane('placeLabels').style.zIndex='650';
map.getPane('placeLabels').style.pointerEvents='none';
const labels=L.tileLayer('https://{s}.basemaps.cartocdn.com/light_only_labels/{z}/{x}/{y}{r}.png',{pane:'placeLabels',maxZoom:20,subdomains:'abcd',className:'place-label-tiles',attribution:'© OpenStreetMap contributors · © CARTO'}).addTo(map);
